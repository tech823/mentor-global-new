          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <ScrollReveal>
                ...
                <h1 className="text-[var(--fs-hero)] font-bold text-[#11111F] tracking-tighter leading-[1.05]">
        ...
        <section className="bg-white py-24 md:py-32">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <ScrollReveal>
              ...
              <h2 className="text-[var(--fs-4xl)] font-bold text-[#11111F] tracking-tight mb-12">
        ...
        <section className="bg-[#11111F] py-24 md:py-32">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <ScrollReveal>
              ...
              <h2 className="text-[var(--fs-4xl)] font-bold text-white tracking-tight mb-12">
