...
export const EcosystemVisual = () => {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-visible pointer-events-none z-0">
      ...
      {/* The Globe */}
      <div className="absolute bottom-[-90px] right-[-90px] w-[320px] h-[320px] sm:bottom-[-110px] sm:right-[-110px] sm:w-[420px] sm:h-[420px] md:bottom-[-150px] md:right-[-150px] md:w-[700px] md:h-[700px] rounded-full bg-[#05050A] shadow-[0_0_100px_rgba(0,72,255,0.15)_inset] border border-white/5 flex items-center justify-center overflow-hidden">
