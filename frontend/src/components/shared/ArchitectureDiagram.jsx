...
export function ArchitectureDiagram() {
  return (
    <div className="relative z-10 flex flex-col items-center w-full py-4">
      ...
      <div className="w-px h-8 bg-gradient-to-b from-[#11111F]/20 to-[#0048FF]/40 relative">
      ...
      <div className="w-[60%] flex justify-between relative">
        <div className="w-px h-6 bg-[#0048FF]/40 relative"></div>
        <div className="w-px h-6 bg-[#0048FF]/40 relative"></div>
      </div>
      ...
      <div className="w-full max-w-[80%] flex justify-center mt-2">
        ...
        <div className="w-px h-6 bg-gradient-to-b from-[#0048FF]/30 to-[#0048FF]/30 relative" />
      </div>
      <div className="w-[85%] border-t border-[#0048FF]/30 relative flex justify-between">
        {[...Array(5)].map((_, i) => (
          <div key={i} className="w-px h-6 bg-[#0048FF]/30" />
        ))}
      </div>
      ...
      <div className="w-px h-6 bg-[#0048FF]/20 mt-2"></div>
      <div className="w-[70%] border-t border-[#0048FF]/20 relative flex justify-between">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="w-px h-6 bg-[#0048FF]/20" />
        ))}
      </div>
      ...
      <div className="flex justify-between w-[100%] -mt-1 gap-5">
        {[
          ...
          >
            ...
            <div className="w-px h-4 bg-[#11111F]/10 group-hover:bg-[#0048FF]/40 transition-colors duration-300" />
